...
theme.Product = (function() {
  function Product(container) {
    ...
    this.classes = {
      ...
      variantAddCart: 'product-form--variant-add-cart'
    };
  ...
  Product.prototype = Object.assign({}, Product.prototype, {
    ...
    _enableAddToCart: function(message) {
      ...
      this.productForm.classList.add(this.classes.variantAddCart);
    },
    ...
    _disableAddToCart: function(message) {
      ...
      this.productForm.classList.remove(this.classes.variantAddCart);
    },
